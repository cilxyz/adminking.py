...
def slowprint(s):
    for c in s + '\n' :
        ...
        sys.stdout.flush()
        time.sleep(6. / 100)
slowprint(" \033[94m[!] Connecting Server : ")
slowprint(" \033[96m[!] Loading........................................ ")
time.sleep(4)
os.system('clear')
def slowprint(s):
    for c in s + '\n' :
...
\033[96m
    _       _           _       _    _
   / \   __| |_ __ ___ (_)_ __ | |/ (_)_ __   __ _
  / _ \ / _` | '_ ` _ \| | '_ \| ' /| | '_ \ / _` |
 / ___ \ (_| | | | | | | | | | | . \| | | | | (_| |
...
print(''' \033[93m
+----------------------------------------------+
|     Best Tool For Admin Login Page Find      |
+----------------------------------------------+''')
slowprint('''\033[93m| coded by : Pwnicated                        
| Telegram : Cilxyz                            |
| Version : v1.0                               |
| This Program Is Made For Penetration Testing |''')
print('''\033[93m+----------------------------------------------+
''')
slowprint("\033[95mYou Have to Enter Website With http:// or https://  ")
slowprint("\033[95mAdd / At The End of Website Like https://example.com/ ")
print("                                                                ")

url = input("\033[96m # Enter Website : ")

print ("\033[95m # Starting  Program : ")
print("                                                                                        ")
